VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} dRepAttendanceDetails 
   Caption         =   "Attendance Details"
   ClientHeight    =   12375
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   22800
   Icon            =   "dRepAttendanceDetails.dsx":0000
   ...
   BeginProperty Section0 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item1 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         EndProperty
         ForeColor       =   16777215
         Object.Caption         =   "Attendance Details"
      EndProperty
      ItemType2       =   3
   ...
   EndProperty
End
Attribute VB_Name = "dRepAttendanceDetails"
Attribute VB_GlobalNameSpace = False
Attribute VB_Creatable = False
Attribute VB_PredeclaredId = True
Attribute VB_Exposed = False
' ===================== ATTENDANCE DETAILS REPORT =====================
' Displays date-specific attendance records
' Key Features:
'   - Binds to attendance_table records
'   - Automatic state cleanup on termination
'   - Date picker reset handling
' ====================================================================

Option Explicit

' --- REPORT TERMINATION EVENT ---
' Cleans up resources and resets state when report closes

Private Sub DataReport_Terminate()

    frmViewAttendance.DTPicker1.Value = ""   ' Reset date selection to empty
    isOpenAttendanceDetails = False          ' Reset attendance details report open state flag
