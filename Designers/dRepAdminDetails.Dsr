VERSION 5.00
Begin {78E93846-85FD-11D0-8487-00A0C90DC8A9} dRepAdminDetails 
   Caption         =   "Admin Details "
   ClientHeight    =   12375
   ClientLeft      =   120
   ClientTop       =   465
   ClientWidth     =   22800
   Icon            =   "dRepAdminDetails.dsx":0000
   ...
   BeginProperty Section4 {1C13A8E0-A0B6-11D0-848E-00A0C90DC8A9} 
      ...
      BeginProperty Item1 {1C13A8E1-A0B6-11D0-848E-00A0C90DC8A9} 
         ...
         EndProperty
         ForeColor       =   16711935
         Object.Caption         =   "Total Admins   :  "
      EndProperty
   EndProperty
End
Attribute VB_Name = "dRepAdminDetails"
...
' Cleans up resources when report closes

Private Sub DataReport_Terminate()

    ' Close database recordset if open
    If frmUserDashboard.RsDataReport.State = adStateOpen Then
        frmUserDashboard.RsDataReport.Close     ' Close active recordset
        Set frmUserDashboard.RsDataReport = Nothing  ' Release object memory
    End If
    
    isOpenAdminDetails = False  ' Reset admin details report open state flag
